export const Features = () => {
  return (
    <section className="z-0 flex h-96 flex-row  justify-center gap-32 bg-background pb-6 text-citrine max-md:h-full  max-md:flex-col max-md:items-center max-md:gap-3 ">
      <section className="flex w-1/5 flex-col items-center rounded-md bg-backgroundCard p-4 text-center max-md:w-4/5">
