  ...
  return (
    <section className="bento  w-4/5">
      <section className="grid grid-flow-row-dense  grid-cols-6 content-center justify-center gap-4   max-xl:grid-cols-1 max-xl:grid-rows-1 ">
        <div className="col-span-4  flex min-h-[20rem] flex-col place-content-center rounded bg-primary pb-20 pt-20 text-5xl font-bold text-background max-xl:pl-12">
        ...
        <div className="col-span-3 flex max-h-[4rem] min-h-[2rem] flex-col place-content-center rounded bg-accent pb-20 pt-20 text-3xl font-bold  text-background max-xl:col-span-4">
